...
# Подменю психологии (без изменений)
...
# Подменю астрологии (без изменений)
...
# ===== НОВОЕ МЕНЮ ПРОФИЛЯ (без "СМЕНИТЬ ИМЯ") =====
