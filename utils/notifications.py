...
async def generate_morning_greeting(user_id: int, destiny: int, is_subscriber: bool):
    if is_subscriber:
        ...
        text = await get_yandex_gpt_response(prompt, user_id, function_name="morning_greeting")
        return text, None
    else:
...
async def generate_motivation(user_id: int, destiny: int, is_subscriber: bool):
    if is_subscriber:
        ...
        text = await get_yandex_gpt_response(prompt, user_id, function_name="motivation")
        return text, None
    else:
...
async def generate_daily_card(user_id: int, destiny: int, is_subscriber: bool):
    if is_subscriber:
        ...
        text = await get_yandex_gpt_response(prompt, user_id, function_name="daily_card_push")
        return text, None
    else:
...
async def generate_fact(user_id: int, destiny: int, is_subscriber: bool):
    if is_subscriber:
        ...
        text = await get_yandex_gpt_response(prompt, user_id, function_name="fact")
        return text, None
    else:
...
async def generate_evening_advice(user_id: int, destiny: int, is_subscriber: bool):
    if is_subscriber:
        ...
        text = await get_yandex_gpt_response(prompt, user_id, function_name="evening_advice")
        return text, None
    else:
