...
def init_prompts(cursor):
    ...
    # ===== ПРОМПТЫ БЕЗ ПЛЕЙСХОЛДЕРОВ (подстановка в коде) =====
    default_prompts = {
        "number": {
            ...
            "free": "Число судьбы: %s. Дай характеристику (5-6 предложений): укажи 2 сильные стороны, 1 слабость, 1 главную задачу в жизни. В конце добавь фразу: «Хотите узнать, как это число влияет на ваши отношения, карьеру и деньги? Полный разбор – по подписке».",
            "paid": "Число судьбы: %s. Дай развёрнутую характеристику (6-8 предложений): сильные стороны, слабости, ключевой жизненный вызов, совет по самореализации. Будь прямолинеен, но с теплотой."
        },
        "daily_card": {
            "system": "Ты — Аркадий Викторович, практикующий психолог и астролог. ...",
            "free": "Сегодняшняя карта дня для числа судьбы %s. Дай краткий прогноз (5-6 предложений): что важно сегодня, один практический совет, вопрос, чтобы задуматься. В конце добавь фразу: «Полная карта дня с практиками и погодой – по подписке».",
            "paid": "Сегодняшняя карта дня для числа судьбы %s. Дай развёрнутый прогноз (6-8 предложений): общий настрой, практическое действие, психологическая практика, вопрос для рефлексии."
        },
        "compatibility": {
            "system": "Ты — Аркадий Викторович, нумеролог и астролог. ...",
            "free": "Число судьбы пользователя %s (знак %s), число партнёра %s (знак %s). Дай краткое описание совместимости (4-5 предложений). Напиши, что их связывает, что будет сложно, и дай один совет. В конце добавь фразу: «Полный разбор по 5 сферам с рекомендациями – по подписке».",
            "paid": "Число судьбы пользователя %s (знак %s), число партнёра %s (знак %s). Опиши совместимость развёрнуто (10-12 предложений) по 5 сферам: любовь, дружба, деньги, секс, интеллект. Дай рекомендации, как улучшить отношения. Будь честен и практичен."
        },
        "horoscope_daily": {
            "system": "Ты — Аркадий Викторович, астролог. ...",
            "free": "Составь астрологический гороскоп на сегодня для человека с числом судьбы %s и знаком зодиака %s. Дай краткий прогноз (5-6 предложений): что важно сегодня, дай один совет, задай вопрос для размышления. В конце добавь фразу: «Полный гороскоп на месяц и ежедневные прогнозы – по подписке».",
            "paid": "Составь астрологический гороскоп на сегодня для человека с числом судьбы %s и знаком зодиака %s. Дай развёрнутый прогноз (6-7 предложений) по 2 сферам (любовь и работа/деньги). Добавь совет на день."
        },
        "sexology": {
            "system": "Ты — Аркадий Викторович, практикующий психолог и сексолог с 20-летним стажем. ...",
            "free": "Дай краткий ответ (3-4 предложения) на вопрос пользователя по сексологии, дай полезный совет, но не раскрывай всех деталей. В конце добавь фразу: «Полная консультация и практические рекомендации – по подписке».",
        ...
        "consultation": {
            "system": "Ты — Аркадий Викторович, практикующий нумеролог, психолог, астролог и сексолог с 20-летним стажем. ...",
            "free": "Ответь на вопрос пользователя кратко (3-4 предложения), но дай чёткий и полезный совет. В конце добавь фразу: «Полная консультация с развёрнутыми рекомендациями – по подписке».",
